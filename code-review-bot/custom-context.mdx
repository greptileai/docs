...
You can customize Greptile's behavior by providing "custom context" for the agent to follow. Context can include custom rules, style guides or docs, and miscellanous information that Greptile may find useful. 
