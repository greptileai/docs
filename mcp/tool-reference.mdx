...
<CardGroup cols={2}>
    <Card title="Custom Context (4 tools)" href="#custom-context-tools">
        Manage coding patterns and organizational standards
    </Card>
    <Card title="Pull Requests (3 tools)" href="#pull-request-tools">
        Access PR data and metadata across repositories
    </Card>
    <Card title="Code Reviews (3 tools)" href="#code-review-tools">
        Manage review lifecycle and results
    </Card>
    <Card title="Comments (1 tool)" href="#comment-tools">
        Search and filter review feedback
    </Card>
</CardGroup>
...
```json
{
  "customContexts": [
    ...
    {
      "id": "memory_1b2c3d4e-5f6g-7h8i-9j0k-1l2m3n4o5p6q",
      "type": "PATTERN",
      "body": "Always validate input parameters in API endpoints",
      "status": "ACTIVE",
      "scopes": {"AND": [{"operator": "MATCHES", "field": "filepath", "value": "**/api/**"}]},
