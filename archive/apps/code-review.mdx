...
You can customize the agent's behavior by providing "special instructions" for the bot to follow, for example, "Include a section on compliance implications of the changes in the PR."
