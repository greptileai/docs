...
Claude will retrieve patterns like:
- "Use async/await instead of Promise.then() for better readability"
- "Always validate input parameters in API endpoints"
...
Ask Claude: *"Find coding patterns related to error handling"* or *"Show me security-related coding standards"*

Claude will return targeted patterns matching your query.

**Use case:** Get specific guidance for the type of code being written.

### Get Pattern Details

Ask Claude: *"Tell me more about the async/await pattern"* or *"Show me details for the input validation pattern"*

Claude will provide:
- Full pattern description
- Usage statistics (evidence count, comments count)
