...
metaTitle: 'Greptile AI Code Review Agent: Automated PR Analysis and Feedback'
metaDescription: Enhance your code review process with Greptile AI-powered agent. Get context-aware comments and codebase-specific feedback on your pull requests.'
---

<Note>Both GitHub & GitLab supported</Note>

Greptile's code review agent does two things:
<Steps>
<Step>
Install agent by clicking [here](https://app.greptile.com/login)
</Step>
<Step>
Select the repos you would like the agent to review new PRs on.
</Step>
<Step>
...
Click [here](https://app.greptile.com/login) to install the PR Review agent.
...
You can customize the bot's behavior by providing "special instructions" for the agent to follow, for example, "Include a section on compliance implications of the changes in the PR."
...
You can also customize the bot's behavior by selecting certain criterion for the agent to evaluate each diff on, for example syntax issues, or style guide violations.
