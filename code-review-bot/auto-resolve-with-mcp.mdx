...
```
@github Can you get all the comments from PR #123 in owner/repo-name? Focus on the ones from the Greptile agent.
```

The MCP server will retrieve all PR comments, including those from Greptile's code review agent.
...
"Show me only the comments from the Greptile agent"
